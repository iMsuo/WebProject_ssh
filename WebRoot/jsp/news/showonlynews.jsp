...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/onlynews.css">
  	<link rel="stylesheet" href="${pageContext.request.contextPath}/css/top.css" type="text/css"></link></head>
...
<div id="logo"><a href="${pageContext.request.contextPath}"><img src="images/logo.jpg"></img></a></div> 
  ...
  <div id="choose">
                              <p> ${page}/${limit}</p>     
 <span>
 <c:if test="${page>1}"><a href="${pageContext.request.contextPath}/onlynews?pageno=${page-1}">上一页</a></c:if>
                                	
 <c:if test="${page<limit}"><a href="${pageContext.request.contextPath}/onlynews?pageno=${page+1}">下一页</a></c:if>
 </span>
  </div>
