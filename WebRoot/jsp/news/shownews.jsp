...
<div id="logo"><a href="${pageContext.request.contextPath}"><img src="images/logo.jpg"></img></a></div> 
  ...
  <div id="main">
    ...
    <div id="choose">
	     <p> ${page}/${limit}</p>   
		 <span>
		 <c:if test="${page>1}"><a href="${pageContext.request.contextPath}/shownews?pageno=${page-1}">上一页</a></c:if>
		                                	
		 <c:if test="${page<limit}"><a href="${pageContext.request.contextPath}/shownews?pageno=${page+1}">下一页</a></c:if>
		 </span>
		</div>
	  <br/>
	  <div class="hotsub">
