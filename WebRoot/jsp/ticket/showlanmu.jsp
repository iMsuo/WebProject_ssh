...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/showlanmu.css">
  </head>
...
<div id="logo"><a href="${pageContext.request.contextPath}"><img src="images/logo.jpg"></img></a></div> 
  <div id="div1"><img src="images/timg.jpg"></img></div><br/>
   ...
   <c:choose>
    ...
    <table>
      <c:forEach items="${lanmu}" var="vars" varStatus="sta">
      <tr><td><a href="${pageContext.request.contextPath}/showtickets?lanmuid=${sta.count}">${vars.lanmuname}</a></td></tr>
      </c:forEach>
    </table>
  </body>
</html>
